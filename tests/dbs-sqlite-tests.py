...
try:
    ...
    sql = "SELECT Count() FROM {} WHERE ext_id='{}' AND title='{}' AND year={} AND media_type='{}'".format(table_name, ext_id, title, year, media_type)
    cur.execute(sql);
    if not cur.fetchone()[0] == 1:
        print(test_name, FAIL, 1);
...
try:
    ...
    db.populate_title_to_ext_id_table(table_name, test_data)
    cur.execute("SELECT Count() FROM {} WHERE ext_id='{}' AND title='{}' AND year={} AND media_type='{}'".format(table_name, ext_id, title, year, media_type));
    if not cur.fetchone()[0] == 1:
        print(test_name, FAIL, 1);
...
try:
    ...
    cur.execute("SELECT Count() FROM sqlite_master WHERE type='table' and name='{}'".format(Sqlite.TITLE_TO_ANIDB_ID));
    if not cur.fetchone()[0] == 1:
        print(test_name, FAIL, 1);
...
try:
    ...
    sql = "SELECT Count() FROM {} WHERE ext_id='{}' AND title='{}' AND year={} AND media_type='{}'".format(Sqlite.TITLE_TO_ANIDB_ID, ext_id, title, year, media_type)
    cur.execute(sql);
    if not cur.fetchone()[0] == 1:
        print(test_name, FAIL, 1);
...
try:
    ...
    cur.execute("SELECT Count() FROM sqlite_master WHERE type='table' and name='{}'".format(Sqlite.TITLE_TO_IMDB_ID));
    if not cur.fetchone()[0] == 1:
        print(test_name, FAIL, 1);
...
try:
    ...
    sql = "SELECT Count() FROM {} WHERE ext_id='{}' AND title='{}' AND year={} AND media_type='{}'".format(Sqlite.TITLE_TO_IMDB_ID, ext_id, title, year, media_type)
    cur.execute(sql);
    if not cur.fetchone()[0] == 1:
        print(test_name, FAIL, 1);
...
try:
    ...
    search_re = re.compile("^{}$".format(title));
    if not db.get_anidb_ids(search_re) == db.get_ext_ids(Sqlite.TITLE_TO_ANIDB_ID, search_re):
        print(test_name, FAIL, 1);
...
try:
    ...
    search_re = re.compile("^{}$".format(title));
    if not db.get_imdb_ids(search_re) == db.get_ext_ids(Sqlite.TITLE_TO_IMDB_ID, search_re):
        print(test_name, FAIL, 1);
