...
if (
    not isinstance(show, (Container, Show)) or
    isinstance(container, Season) or
    isinstance(container, Extra)
):
    print(test_name, FAIL)
...
if (
    not isinstance(season, (Container, Show, Season)) or
    isinstance(container, Extra)
):
    print(test_name, FAIL)
...
if container.get_container(RANDOM_STR2) is not None:
    print(test_name, FAIL)
...
show = Show(RANDOM_STR)
if (
    not show.show_name() == RANDOM_STR or
    not show.show_name() == show.container_name
):
    print(test_name, FAIL)
...
season = Season(RANDOM_STR, RANDOM_INT)
if (
    not season.season_name() == RANDOM_STR or
    not season.season_name() == season.container_name
):
    print(test_name, FAIL)
